                ...
                <ul class="scrollable__content py-2">
                    ...
                    <li>
                        ...
                        <ul class="menu__sub-open">
                            ...
                            <li>
                                <a href="side-menu-light-validation.html" class="menu menu--active">
                                    <div class="menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        <!-- END: Mobile Menu -->
        <!-- BEGIN: Top Bar -->
        <div class="top-bar-boxed h-[55px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12" style="margin-bottom: 30px;">
            <div class="h-full flex items-center">
                ...
                <div class="intro-x relative mr-3 sm:mr-6">
                    <div class="search hidden sm:block">
                        <input type="text" class="search__input form-control border-transparent" placeholder="Cari Transaksi Customer...">
            ...
            <ul>
                ...
                <li>
                    <a href="javascript:;" class="top-menu">
                        ...
                        <div class="top-menu__title"> Customers <i data-lucide="chevron-down" class="top-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="" id="menucustom">
                        <li>
                            <a href="app?p=customers" class="top-menu">
                                <div class="top-menu__icon"> <i data-lucide="user"></i> </div>
                                <div class="top-menu__title"> Customers / Pelanggan</div>
                            </a>
                        </li>
                        <li>
                            <a href="app?p=membership" class="top-menu">
                                <div class="top-menu__icon"> <i data-lucide="award"></i> </div>
                                <div class="top-menu__title"> Membership / Keanggotaan </div>
                            </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="top-menu">
                        ...
                        <div class="top-menu__title"> Transaction <i data-lucide="chevron-down" class="top-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="" id="menucustom">
                        <li>
                        ...
                        <li>
                            <a href="app?p=cancel" class="top-menu">
                                ...
                                <div class="top-menu__title"> Cancel / Pembatalan</div>
                            </a>
                        </li>
                        <li>
                            <a href="app?p=rewash" class="top-menu">
                                <div class="top-menu__icon"> <i data-lucide="refresh-cw"></i> </div>
                                <div class="top-menu__title"> Rewash / Cuci Ulang</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="" id="menucustom">
                        <li>
                            <a href="app?p=report" class="top-menu">
                                <div class="top-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="top-menu__title"> Report Data </div>
                            </a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="top-menu">
                        ...
                        <div class="top-menu__title"> Management <i data-lucide="chevron-down" class="top-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="" id="menucustom">
                        <li>
                            <a href="javascript:;" class="top-menu">
