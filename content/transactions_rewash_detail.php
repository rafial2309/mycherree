            <?php 
            $data = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from Invoice_Rewash WHERE Inv_Number='$_GET[invoice]'")); 
            ?>
                            ...
                            <div class="box p-5 rounded-md">
                                ...
                                <div class="overflow-auto lg:overflow-visible -mt-3">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $queryitem = mysqli_query($conn,"SELECT * from Invoice_Rewash_Item where Inv_Number='$data[Inv_Number]'");
