                ...
                <div class="content">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
                            ...
                            <button class="btn btn-primary mr-1 mb-2" onclick="ambildata2()">Generate Detail</button>
                            <br>
                            <hr>
                            <br>
                            <div id="hasilajax">
            ...
            <script type="text/javascript">
                ...
                function ambildata() {
                    ...
                    if (tgl1=='') {
                        ...
                        $.ajax({
                        url:'function/deadline.php?tgl1='+tgl1,
                        type:'GET',
                        dataType:'html',
                ...
                function ambildata2() {
                    ...
                    if (tgl1=='') {
                        ...
                        $.ajax({
                        url:'function/deadline_detail.php?tgl1='+tgl1,
                        type:'GET',
                        dataType:'html',
                        success:function (response) {
                            $('#hasilajax').html(response);
