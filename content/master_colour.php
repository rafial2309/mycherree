            ...
            <div class="wrapper-box">
                ...
                <div class="content">
                    <div class="intro-y flex items-center h-10 mt-5">
                        ...
                        <button class="ml-auto btn btn-primary shadow-md mr-2" href="javascript:;" data-tw-toggle="modal" data-tw-target="#new-customer-modal"><i data-lucide='plus-circle' class='w-5 h-5'></i> &nbsp; Add New Colour</button>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $('#example').DataTable( {
                        "ajax":{
                            url :"content/ajax/master_colour_processing.php",
                            type: "post",
                            error: function(){
                                $(".dataku-error").html("");
